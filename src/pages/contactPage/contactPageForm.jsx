...
useEffect(() => {
  ...
  const adjustCalendlyStyles = () => {
    const body = document.body;

    if (body.style.position === "fixed" && body.style.left === "0px") {
  ...
  const observer = new MutationObserver(() => {
    const isPopupOpen = !!document.querySelector(".calendly-popup");

    if (isPopupOpen && !intervalId) {
      intervalId = setInterval(adjustCalendlyStyles, 100);
    } else if (!isPopupOpen && intervalId) {
  ...
  const handleFormSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        ...
        { ...formDetails, captchaToken: token },
  ...
  return (
    <div className="contact-form-background">
      <div className="contact-nav-wrapper">
        <div
          className={
            currentStep === 0 ? "contact-nav-first" : "contact-nav-header"
          }
        >
          <Link to="/">
            <div
      ...
      <div
        className={
          currentStep === 0 ? "contact-form-first-section" : "contact-form"
        }
      >
        <div
          className={
            currentStep === 0
              ? "contact-form-first-wrapper"
        ...
        {currentStep === 0 && (
                ...
                onClick={() => {
                  if (window.Calendly) {
                    window.Calendly.initPopupWidget({
                      url: 'https://calendly.com/cameron-clubsoda/clubsoda-meeting'
                    });
                  } else {
                    alert("Calendly is not loaded yet. Please try again in a moment.");
                  }
                  return false;
                }}
              >
          ...
          {currentStep === 1 && (
            <>
              ...
              <div className="contact-form-choice">
                <h3>
                  {parse(acf.contact_form_step_1.contact_form_step_1_question)}
                </h3>
                  ...
                  {acf.contact_form_step_1.contact_form_step_1_options.map(
                    (option) => (
                      <button
                        ...
                        onClick={() =>
                          handleCategorySelection(option.option_title)
                        }
                        className={
                          formDetails.formData.category.includes(
                            option.option_title
                          )
                            ? "selected"
                            : ""
                        }
                        aria-pressed={formDetails.formData.category.includes(
                          option.option_title
                        )}
                      >
                        {option.option_title}
              ...
              <div className="contact-form-next contact-form-next-1">
                <span>
                  <Link to="/recruit">
                    *SEEKING REPRESENTATION or collaboration? VISIT RECRUIT PAGE
                  </Link>
          ...
          {currentStep === 2 && (
            <>
              ...
              <div className="contact-form-choice">
                <h3>
                  {parse(acf.contact_form_step_2.contact_form_step_2_question)}
                </h3>
                <div className="contact-form-choices">
                  {acf.contact_form_step_2.contact_form_step_2_options.map(
                    (option) => (
                      <button
                        key={option.option_title}
                        onClick={() =>
                          setFormData((prev) => ({
                            ...
                            formData: {
                              ...prev.formData,
                              budget: option.option_title,
                            },
                          }))
                        }
                        className={
                          formDetails.formData.budget === option.option_title
                            ? "selected"
                            : ""
                        }
                      >
          ...
          {currentStep === 3 && (
            <>
              ...
              <div className="contact-form-choice">
                <h3>
                  {parse(acf.contact_form_step_3.contact_form_step_3_question)}
                </h3>
                <div className="contact-form-choices">
                  {acf.contact_form_step_3.contact_form_step_3_options.map(
                    (option) => (
                      <button
                        key={option.option_title}
                        onClick={() =>
                          setFormData((prev) => ({
                            ...
                            formData: {
                              ...prev.formData,
                              start: option.option_title,
                            },
                          }))
                        }
                        className={
                          formDetails.formData.start === option.option_title
                            ? "selected"
                            : ""
                        }
                      >
            ...
            <>
              ...
              <div className="contact-form-choice">
                <h3 style={{ marginBottom: 0 }}>
                  {parse(acf.contact_form_step_4.step_4_heading)}
                </h3>
          ...
          {currentStep === 5 && (
            <>
              ...
              <div className="contact-form-choice">
                <h3 style={{ marginBottom: 0 }}>
                  {parse(acf.contact_form_step_5.step_5_heading)}
                </h3>
          ...
          {currentStep === 6 && (
            <>
              ...
              <div className="contact-form-choice">
                <h3 style={{ marginBottom: 0 }}>
                  {parse(acf.contact_form_step_6.step_6_heading)}
                </h3>
          ...
          {currentStep === 7 && (
            <>
              ...
              <div className="contact-form-choice">
                <h3 style={{ marginBottom: 0 }}>
                  {parse(acf.contact_form_step_7.step_7_heading)}
                </h3>
                    ...
                    <button
                      ...
                      onClick={() =>
                        setFormData((prev) => ({
                          ...
                          formData: {
                            ...prev.formData,
                            projectType: option.step_8_options_title,
                          }, // Updated state key
                        }))
                      }
                      className={
                        formDetails.formData.projectType ===
                        option.step_8_options_title
                          ? "selected"
                          : ""
                      }
                    >
